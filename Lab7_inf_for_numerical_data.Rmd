...
I would expect for there to be no relationship between weight and days physically active. This is because in people can weigh more naturally, but also weigh more depending on the amount of body muscle obtained, which weighs heavier than fat. The box plot shows that there is not a definitive relationship with each other and the IQR is equivalent to each other.  
